...
import images from "../../data/production/NYMLindsayLohan.json";

export async function getStaticProps(){
  return {props:{images}};
}
export default function LindsayLohan({images}) {
  ...
  return (
    <main className=" pt-32 min-h-screen px-6 py-10 text-gray-900">
      ...
      <p className="text-center text-xs font-mono tracking-widest uppercase whitespace-pre-wrap">
        <u>Location:</u> Waldorf Astoria New York <br></br>
        ...
        <u>Subject:</u> Lindsay Lohan<br></br>
        <u>Wardrobe Stylist:</u> Daniel Edley <br></br>
        <u>Wardrobe Assistants:</u> Grace Providencia Wagner, Lexi Lang <br></br>
        <u>Tailor:</u> Susan Balcunas <br></br>
        <u>Hair:</u> Peter Gray @homeagency using @owayusaofficial<br></br>
        <u>Hair Assistant:</u> Gina Marie Picciotto<br></br>
        <u>Make-up:</u> Hung Vanngo for Hung Vanngo Beauty at The Wall Group<br></br>
