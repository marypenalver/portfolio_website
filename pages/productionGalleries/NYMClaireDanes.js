...
import images from "../../data/production/NYMClaireDanes.json";

export async function getStaticProps(){
  return {props:{images}};
}
export default function ClaireDanes({images}) {
  ...
  return (
    <main className=" pt-32 min-h-screen px-6 py-10 text-gray-900">
      ...
      <p className="text-center text-xs font-mono tracking-widest uppercase whitespace-pre-wrap">
        <u>Location:</u> Baryshnikov Arts Center<br></br>
        ...
        <u>Subject:</u> Claire Danes<br></br>
        ...
        <u>Make-up:</u> Makeup by Matin at TraceyMattingly.com<br></br>
