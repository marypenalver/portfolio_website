...
import images from "../../data/production/billyeichner.json";

export async function getStaticProps(){
  return {props:{images}};
}
export default function BillyEichner({images}) {
  ...
  const [loaded, setLoaded] = useState(Array(images.length).fill(false));
    ...
    <main className=" pt-32 min-h-screen px-6 py-10 text-gray-900">
      ...
      <p className="text-center text-xs font-mono tracking-widest uppercase whitespace-pre-wrap">
        ...
        <u>Client:</u> Macmillan Publishers <br></br>
        <u>Subject:</u> Billy Eichner<br></br>
